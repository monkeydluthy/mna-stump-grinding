      ...
      try {
        ...
        const transformedItems = response.data.map((item) => {
          if (item.type === 'gallery' && item.images) {
            ...
            return {
              ...item,
              images: item.images, // Already Cloudinary URLs
            };
          } else if (item.type === 'standalone') {
            // Use Cloudinary URL if available, otherwise fallback to filename
            return {
              ...item,
              filename:
                item.cloudinaryUrl ||
                item.filename ||
                `/api/uploads/${item.filename}`,
            };
            ...
            return {
              ...item,
              beforeImage:
                item.beforeImageCloudinaryUrl ||
                `/api/uploads/${item.beforeImage}`,
              afterImage:
                item.afterImageCloudinaryUrl ||
                `/api/uploads/${item.afterImage}`,
            };
          }
          return item;
        });
      ...
      <div>
        ...
        >
          <div className="container">
            ...
            >
              See our professional stump grinding work. Every job is completed
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <strong style={{ color: 'var(--text-dark)' }}>Media:</strong>{' '}
                  Video
                </div>
              </div>
            </div>
